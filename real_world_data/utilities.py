...
def get_arguments():
    ...
    #network1 parameter
    parser.add_argument('--net1_h1', type=int, default="500", help="main network hidden layer 1 size")
    parser.add_argument('--net1_h2', type=int, default="100", help="main network hidden layer 2 size")
...
def load_data(data_dir):
    train_x_full = genfromtxt(data_dir + 'train_x.txt', delimiter=',')
    train_y_full = genfromtxt(data_dir + 'train_y.txt', delimiter=',')
    test_x = genfromtxt(data_dir + 'test_x.txt', delimiter=',')
    test_y = genfromtxt(data_dir + 'test_y.txt', delimiter=',')
    S_30 = genfromtxt(data_dir + '30percent_S.txt', delimiter=',')
    train_x, val_x, train_y, val_y = train_test_split(train_x_full,  train_y_full, test_size=0.2)   
    return train_x, train_y, val_x, val_y, test_x, test_y, S_30

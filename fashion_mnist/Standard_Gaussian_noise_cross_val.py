...
with open(filename, 'a') as newFile:
    headers = ['sigma','reg_param1', 'reg_param2', 'validation_accuracy']
    newFileWriter = csv.DictWriter(newFile, fieldnames=headers)
    if not file_exists:
    	newFileWriter.writeheader()

    newFileWriter.writerow({'sigma': args.sigma,  'reg_param1': args.reg_param1, 'reg_param2': args.reg_param2, 'validation_accuracy': val_accuracy})
